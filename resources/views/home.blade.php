...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('css/home/soft-design-system.css') }}" rel="stylesheet" />
</head>
...
<body class="about-us">
    ...
    <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3  navbar-transparent ">
        <div class="container">
            <a class="navbar-brand  text-white " href="#" rel="tooltip" title="Logicode" data-placement="bottom">
                Logicode
            </a>
            ...
            <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0 ms-lg-12 ps-lg-12" id="navigation">
                <ul class="navbar-nav navbar-nav-hover w-100">
                    <li class="nav-item my-auto ms-5 ms-auto">
                        <a href="{{ route('login') }}" class="btn btn-sm bg-white btn-round mb-0 me-2 mt-2 mt-md-0">Login</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center mx-auto my-auto">
                        <h1 class="text-white">Logicode Indonesia</h1>
                        <p class="lead mb-4 text-white opacity-8">We're try and actualize our dreams for the young generation Indonesia</p>
                        <button type="submit" class="btn bg-white text-dark mt-4">
            ...
            <div class="row align-items-center">
                        ...
                        <g transform="translate(1716.000000, 291.000000)">
                          <g transform="translate(4.000000, 301.000000)">
                            ...
                            <path class="color-background" d="M36.0983333,22.7383333 C36.9280725,27.5056357 35.3832611,32.3782594 31.9583333,35.7966667 C31.0587397,36.6879974 30.0508686,37.4629382 28.9583333,38.1033333 C28.3033941,38.4890431 27.4704606,38.3827841 26.9333333,37.845 L23.6166667,34.53 C28.5053053,31.4496338 32.7452344,27.4440926 36.0983333,22.7383333 L36.0983333,22.7383333 Z" id="color-3" opacity="0.598539807"></path>
                                ...
                                <p>Learn the basics of programming languages</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info">
                        ...
                        <g transform="translate(1716.000000, 291.000000)">
                          <g id="credit-card" transform="translate(453.000000, 454.000000)">
                            ...
                            <path class="color-foreground" d="M0,16.125 L0,32.25 C0,34.2297917 1.60354167,35.8333333 3.58333333,35.8333333 L39.4166667,35.8333333 C41.3964583,35.8333333 43,34.2297917 43,32.25 L43,16.125 L0,16.125 Z M19.7083333,26.875 L7.16666667,26.875 L7.16666667,23.2916667 L19.7083333,23.2916667 L19.7083333,26.875 Z M35.8333333,26.875 L28.6666667,26.875 L28.6666667,23.2916667 L35.8333333,23.2916667 L35.8333333,26.875 Z"></path>
                                ...
                                <h5>Article</h5>
                                <p>Contains the latest collection of articles about the world of programming</p>
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-start">
                        ...
                        <g transform="translate(1716.000000, 291.000000)">
                          <g id="box-3d-50" transform="translate(603.000000, 0.000000)">
                            ...
                            <path class="color-background" d="M20.4472136,21.5347318 L1.4472136,12.0347318 C0.953235098,11.7877425 0.352562058,11.9879669 0.105572809,12.4819454 C0.0361450918,12.6208008 6.47121774e-16,12.7739139 0,12.929159 L0,30.1875 L0,30.1875 C0,30.6849375 0.280875,31.1390625 0.7258125,31.3621875 L19.5528096,40.7750766 C20.0467945,41.0220531 20.6474623,40.8218132 20.8944388,40.3278283 C20.963859,40.1889789 21,40.0358742 21,39.8806379 L21,22.429159 C21,22.0503869 20.7859976,21.7041238 20.4472136,21.5347318 Z" opacity="0.7"></path>
                                ...
                                <h5>Quiz</h5>
                                <p>Evaluating learning outcomes</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info">
                ...
                <div class="col-lg-4 ms-auto mt-lg-0 mt-4">
                    <div class="card shadow-lg">
                        <div class="card-header px-6 mx-3 mt-3 position-relative z-index-1">
                            <div class="d-block blur-shadow-image">
                                <img src="{{ asset('img/primer-vertikal.png') }}" width="200" height="200" alt="img-blur-shadow" class="img-fluid shadow rounded-3">
                            </div>
                        </div>
                        <div class="card-body">
                            <a href="javascript:;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 m-auto">
                    ...
                    <p class="mb-4">
                        You want to get information about Logicode. Please enter your email and click the subscribe button. Thank you 🙏🏼
                    </p>
                    <div class="row">
                        <div class="col-8">
        ...
        <div class="container">
            <div class=" row">
                <div class="col-md-3 mb-4 ms-auto">
                    <div>
                        <h6 class="text-gradient text-primary font-weight-bolder">Logicode</h6>
                    </div>
                    <div>
                ...
                <div class="col-12">
                    <div class="text-center">
                        <p class="my-4 text-sm">
                            ...
                            </script> Logicode Design by <a href="/" target="_self">Dream Team</a>.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('js/home/plugins/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ asset('js/home/plugins/countup.min.js') }}"></script>
    <script src="{{ asset('js/home/plugins/parallax.min.js') }}"></script>
    <!--  Google Maps Plugin    -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDTTfWur0PDbZWPr7Pmq8K3jiDp0_xUziI"></script>
    <script src="{{ asset('js/home/soft-design-system.min.js') }}" type="text/javascript"></script>
    <script>
